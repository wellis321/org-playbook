...
<div class="bg-gradient-to-b from-slate-50 to-slate-100 py-16">
    <div class="container mx-auto max-w-5xl px-4">
        ...
        <div class="mb-8 rounded-xl bg-white p-8 shadow-sm">
            ...
            <p class="mb-4 text-slate-600">
                This approach is implemented using MongoDB, which provides the flexibility to model these relationships effectively:
            </p>
            <ul class="list-disc pl-6 space-y-2 text-slate-600">
                <li><strong>People collection:</strong> Stores core information about individuals</li>
                <li><strong>Roles collection:</strong> Tracks all roles a person has held with temporal data</li>
                <li><strong>Relationships collection:</strong> Defines connections between people with context and history</li>
            </ul>

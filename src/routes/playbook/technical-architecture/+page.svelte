...
<div class="bg-gradient-to-b from-slate-50 to-slate-100 py-16">
    <div class="container mx-auto max-w-5xl px-4">
        ...
        <div class="mb-8 rounded-xl bg-white p-8 shadow-sm">
            ...
            <ul class="list-disc pl-6 space-y-2 text-slate-600">
                <li><strong>Frontend/Backend:</strong> SvelteKit for fast, efficient applications</li>
                <li><strong>Database:</strong> MongoDB for flexible data storage</li>
                <li><strong>Authentication:</strong> JWT tokens and secure HTTP-only cookies</li>
                <li><strong>API:</strong> RESTful endpoints with TypeScript for type safety</li>
            </ul>
        </div>
